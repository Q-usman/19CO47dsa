/*	
 ...
 COURSE: DATA STRUCTURE LAB.
  ...
  Experiment No 9(1):Implementation of stack using Linked List
...
struct stack *push(struct stack *h,int d)	//resemebles insertAtBeg of SLL
{
struct stack *p,*tmp;
...
struct stack *pop(struct stack *h)		//resembles removeFirst of SLL
{
struct stack *tmp;
if(h!=NULL)
{
...
struct stack *top;
int ch,d;
top=NULL;		//initialization of stack pointed by top
while(1)
{
printf("\n\n\n\t\t\tMENU");
